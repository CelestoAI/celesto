...
if TYPE_CHECKING:
    from ..models.user_create_extra_info_type_0 import UserCreateExtraInfoType0
...
class UserCreate:
    ...
    Attributes:
        ...
        extra_info (None | Unset | UserCreateExtraInfoType0):
    """
    ...
    extra_info: None | Unset | UserCreateExtraInfoType0 = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.user_create_extra_info_type_0 import UserCreateExtraInfoType0  # noqa: PLC0415
        ...
        if isinstance(self.extra_info, Unset):
            extra_info = UNSET
        elif isinstance(self.extra_info, UserCreateExtraInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_extra_info(data: object) -> None | Unset | UserCreateExtraInfoType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_info_type_0 = UserCreateExtraInfoType0.from_dict(data)

                return extra_info_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UserCreateExtraInfoType0, data)
