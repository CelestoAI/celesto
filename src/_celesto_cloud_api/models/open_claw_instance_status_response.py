...
if TYPE_CHECKING:
    from ..models.open_claw_instance_status_response_health_type_0 import (
        OpenClawInstanceStatusResponseHealthType0,
    )


T = TypeVar("T", bound="OpenClawInstanceStatusResponse")


@_attrs_define
class OpenClawInstanceStatusResponse:
    """
    Attributes:
        instance_id (str):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.health, Unset):
            health = UNSET
        elif isinstance(self.health, OpenClawInstanceStatusResponseHealthType0):
        ...
        pairing_error: None | str | Unset
        if isinstance(self.pairing_error, Unset):
            pairing_error = UNSET
        else:
        ...
        if pairing_error is not UNSET:
            field_dict["pairing_error"] = pairing_error
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_health(
            data: object,
        ) -> None | OpenClawInstanceStatusResponseHealthType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                health_type_0 = OpenClawInstanceStatusResponseHealthType0.from_dict(
                    data
                )
                ...
                pass
            return cast(None | OpenClawInstanceStatusResponseHealthType0 | Unset, data)
        ...
        def _parse_pairing_error(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        pairing_error = _parse_pairing_error(d.pop("pairing_error", UNSET))
        ...
        open_claw_instance_status_response = cls(
            instance_id=instance_id,
            status=status,
            provider=provider,
            model=model,
        ...
        open_claw_instance_status_response.additional_properties = d
        return open_claw_instance_status_response
