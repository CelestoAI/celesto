...
class SecretListResponse:
    """List response for secrets

    Attributes:
        data (list[SecretListItem]):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.secret_list_item import SecretListItem  # noqa: PLC0415
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = SecretListItem.from_dict(data_item_data)
