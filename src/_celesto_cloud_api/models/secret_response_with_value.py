...
T = TypeVar("T", bound="SecretResponseWithValue")


@_attrs_define
class SecretResponseWithValue:
    """Response schema for secret with full unmasked value (GET by ID only)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        secret_response_with_value = cls(
            id=id,
            key_name=key_name,
            name=name,
            scope_type=scope_type,
        ...
        secret_response_with_value.additional_properties = d
        return secret_response_with_value
