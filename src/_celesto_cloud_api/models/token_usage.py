...
class TokenUsage:
    ...
    Attributes:
        input_ (int | None | Unset):
        output (int | None | Unset):
        total (int | None | Unset):
    """

    input_: int | None | Unset = UNSET
    output: int | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_input_(data: object) -> int | None | Unset:
            if data is None:
                return data
        ...
        def _parse_output(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
