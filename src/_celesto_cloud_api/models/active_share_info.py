...
T = TypeVar("T", bound="ActiveShareInfo")


@_attrs_define
class ActiveShareInfo:
    """Share status for authenticated trace views.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        active_share_info = cls(
            is_shared=is_shared,
            token=token,
            expires_at=expires_at,
        )

        active_share_info.additional_properties = d
        return active_share_info
