...
if TYPE_CHECKING:
    from ..models.trace_list_item import TraceListItem
...
class TraceListResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.trace_list_item import TraceListItem  # noqa: PLC0415
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = TraceListItem.from_dict(data_item_data)
