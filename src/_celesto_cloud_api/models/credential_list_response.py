...
class CredentialListResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.credential_response import CredentialResponse  # noqa: PLC0415
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = CredentialResponse.from_dict(data_item_data)
        ...
        credential_list_response.additional_properties = d
