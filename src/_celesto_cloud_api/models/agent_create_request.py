...
if TYPE_CHECKING:
    from ..models.agent_create_request_config_type_0 import (
...
class AgentCreateRequest:
    ...
    Attributes:
        ...
        config (AgentCreateRequestConfigType0 | None | Unset):
    ...
    config: AgentCreateRequestConfigType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.config, Unset):
            config = UNSET
        elif isinstance(self.config, AgentCreateRequestConfigType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_config(data: object) -> AgentCreateRequestConfigType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                config_type_0 = AgentCreateRequestConfigType0.from_dict(data)

                return config_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AgentCreateRequestConfigType0 | None | Unset, data)
