...
from ...models.host_heartbeat_request import HostHeartbeatRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/internal/hosts/{host_id}/heartbeat".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Host agent heartbeat with current utilization

    Args:
        host_id (str):
        x_agent_key (str): Host agent shared secret
        body (HostHeartbeatRequest): Heartbeat from a host agent with current utilization.
