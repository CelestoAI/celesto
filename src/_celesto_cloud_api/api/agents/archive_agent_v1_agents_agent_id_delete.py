...
from ...models.agent_archive_response import AgentArchiveResponse
...
) -> AgentArchiveResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = AgentArchiveResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AgentArchiveResponse | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        AgentArchiveResponse | HTTPValidationError
    """
