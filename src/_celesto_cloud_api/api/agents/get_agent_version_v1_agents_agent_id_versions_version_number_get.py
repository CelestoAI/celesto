...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/agents/{agent_id}/versions/{version_number}".format(
...
) -> AgentVersionResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = AgentVersionResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AgentVersionResponse | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        AgentVersionResponse | HTTPValidationError
    """
