...
from ...models.computer_exec_response import ComputerExecResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/computers/{computer_id}/exec".format(
...
) -> ComputerExecResponse | ComputerValidationErrorResponse | None:
    if response.status_code == 200:
        response_200 = ComputerExecResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ComputerExecResponse | ComputerValidationErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ComputerExecResponse | ComputerValidationErrorResponse
    """
