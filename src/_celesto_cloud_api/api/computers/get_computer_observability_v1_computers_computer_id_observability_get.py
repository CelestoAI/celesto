...
from ...models.computer_observability_response import ComputerObservabilityResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/computers/{computer_id}/observability".format(
...
) -> ComputerObservabilityResponse | ComputerValidationErrorResponse | None:
    if response.status_code == 200:
        response_200 = ComputerObservabilityResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ComputerObservabilityResponse | ComputerValidationErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ComputerObservabilityResponse | ComputerValidationErrorResponse
    """
