...
from ...models.open_claw_llm_config_request import OpenClawLLMConfigRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/openclaw/{instance_id}/llm".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Configure the OpenClaw LLM provider
