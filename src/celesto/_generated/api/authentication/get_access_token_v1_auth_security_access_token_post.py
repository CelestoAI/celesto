...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/auth/security/access-token",
    }
...
) -> AccessTokenResponse | HTTPValidationError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AccessTokenResponse | HTTPValidationError]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Access Token
     ...
     Generate or retrieve a long-lived API key for the authenticated user.

    The key is bound to the requested organization context.
...
def sync(
    *,
    ...
    Returns:
        AccessTokenResponse | HTTPValidationError
    """
