...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/end_users/{end_user_id}/credentials".format(
...
) -> CredentialListResponse | HTTPValidationError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CredentialListResponse | HTTPValidationError]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """List an end user's credentials (never the secrets)
...
def sync(
    ...
    *,
    ...
    Returns:
        CredentialListResponse | HTTPValidationError
    """
