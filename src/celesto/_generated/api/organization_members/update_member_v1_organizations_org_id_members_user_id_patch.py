...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = OrganizationMemberRead.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Update a member's role or status
     ...
     Updates a member's role or status. Requires admin permissions.

    Args:
        org_id (str): The ID of the organization
        user_id (str):
        body (MemberUpdate): Schema for updating a member's role or status.
