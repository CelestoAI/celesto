...
) -> ComputerValidationErrorResponse | list[ComputerPublishedPortResponse] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ComputerPublishedPortResponse.from_dict(
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ComputerValidationErrorResponse | list[ComputerPublishedPortResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ComputerValidationErrorResponse | list[ComputerPublishedPortResponse]
    """
