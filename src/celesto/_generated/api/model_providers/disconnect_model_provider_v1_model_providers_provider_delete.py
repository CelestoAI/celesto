...
from ...models.model_provider_disconnect_response import ModelProviderDisconnectResponse
...
) -> HTTPValidationError | ModelProviderDisconnectResponse | None:
    if response.status_code == 200:
        response_200 = ModelProviderDisconnectResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ModelProviderDisconnectResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | ModelProviderDisconnectResponse
    """
