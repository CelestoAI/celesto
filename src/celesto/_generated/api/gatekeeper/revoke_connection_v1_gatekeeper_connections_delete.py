...
from ...models.delegated_access_revoke_response import DelegatedAccessRevokeResponse
...
) -> DelegatedAccessRevokeResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = DelegatedAccessRevokeResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DelegatedAccessRevokeResponse | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        DelegatedAccessRevokeResponse | HTTPValidationError
    """
