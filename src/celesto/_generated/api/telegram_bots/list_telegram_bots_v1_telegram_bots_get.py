...
from ...models.telegram_bot_list_response import TelegramBotListResponse
...
def _get_kwargs(
    *,
    ...
    if isinstance(status, Unset):
        json_status = UNSET
    elif isinstance(status, TelegramBotStatus):
...
) -> HTTPValidationError | TelegramBotListResponse | None:
    if response.status_code == 200:
        response_200 = TelegramBotListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | TelegramBotListResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        project_id (None | str | Unset): Project to list bots from
        organization_id (None | str | Unset): Organization; uses its default project
        agent_id (None | str | Unset): Only bots pointing at this agent
        status (None | TelegramBotStatus | Unset):
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | TelegramBotListResponse
    """
