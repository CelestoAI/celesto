...
from ...models.document_tags_update import DocumentTagsUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/documents/{document_id}/tags".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        document_id (str):
        body (DocumentTagsUpdate): Schema for updating document tags
