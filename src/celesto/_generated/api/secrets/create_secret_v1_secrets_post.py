...
from ...models.secret_create_request import SecretCreateRequest
...
def sync_detailed(
    *,
    ...
    """Create a new secret
     ...
     Create a new secret with optional encryption.

    Args:
        body (SecretCreateRequest): Request schema for creating a new secret
