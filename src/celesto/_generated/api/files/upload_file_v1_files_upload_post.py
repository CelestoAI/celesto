...
from ...models.body_upload_file_v1_files_upload_post import (
...
def _get_kwargs(
    *,
    body: BodyUploadFileV1FilesUploadPost,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    The file will be stored in S3 and its metadata in the database.
    Returns the file metadata with a download URL.
