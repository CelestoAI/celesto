...
T = TypeVar("T", bound="RuntimeSettingsUpdateRequest")
...
class RuntimeSettingsUpdateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        runtime_settings_update_request = cls(
            default_end_user_budget_usd=default_end_user_budget_usd,
        )

        runtime_settings_update_request.additional_properties = d
        return runtime_settings_update_request
