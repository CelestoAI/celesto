...
T = TypeVar("T", bound="DriveAccessRulesUpdate")


@_attrs_define
class DriveAccessRulesUpdate:
    """Request to update access rules for a connection.

    Attributes:
        allowed_folders (list[str] | Unset): Folder IDs with recursive access
        allowed_files (list[str] | Unset): Individual file IDs
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        drive_access_rules_update = cls(
            allowed_folders=allowed_folders,
            allowed_files=allowed_files,
        )

        drive_access_rules_update.additional_properties = d
        return drive_access_rules_update
