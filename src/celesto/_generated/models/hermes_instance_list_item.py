...
T = TypeVar("T", bound="HermesInstanceListItem")


@_attrs_define
class HermesInstanceListItem:
    """
    Attributes:
        instance_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hermes_instance_list_item.additional_properties = d
        return hermes_instance_list_item
