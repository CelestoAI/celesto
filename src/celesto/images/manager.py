...
#
# Celesto checks its own env vars first, then falls back to boto3's
...
#
# Empty by default — Celesto ships its kernel via :data:`BASE_KERNELS` in
# `celesto.images.published` and rootfs images via :data:`MANIFEST` there.
