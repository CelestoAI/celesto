...
"""Public boot-profile helpers for custom Celesto images."""
...
from celesto.runtime.boot_profiles import normalize_arch, safe_kernel_trim_args
from celesto.types import RootfsFormat
...
class DirectKernelBoot:
    ...
    The root filesystem and init path are caller-owned, but Celesto owns the
