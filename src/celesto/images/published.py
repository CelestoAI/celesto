...
"""Published pre-built VM images for Celesto presets.
...
intentionally independent of the Celesto package version because image and
...
from celesto.images.manager import ImageManager, ImageSource, LocalImage
...
class BaseKernel(BaseModel):
    """Per-arch Celesto-built microvm kernels — two formats from one build.
...
IMAGES_RELEASE_TAG = "images-2026.09.07.0"
...
def _release_asset_url(preset: Preset, arch: Arch, suffix: str, os: Os = "ubuntu") -> str:
    ...
    return f"https://github.com/CelestoAI/Celesto/releases/download/{_images_release_tag()}/{slug}"
...
def _release_kernel_url(arch: Arch, fmt: KernelFormat) -> str:
    ...
    """
    return (
        f"https://github.com/CelestoAI/Celesto/releases/download/"
        f"{_images_release_tag()}/vmlinux-{arch}.{fmt}"
    )


# Per-arch Celesto-built kernels. Each :class:`BaseKernel` carries BOTH the
...
_OPENCLAW_AMD64_ROOTFS_SHA = "9916bbec24f7b332e8ade0af33a44c2344cef05fa08be63f34d69d86db6f4d30"
_OPENCLAW_ARM64_ROOTFS_SHA = "cafde5c68b32b4e3c46b101d68b34b496e7e132e1222cedefbd0a929d4a5499e"
_CODEX_AMD64_ROOTFS_SHA = "23d9a7bb66cbbcdb5482035673b789231573476b10a32b3261843a42bf00c6d6"
_CODEX_ARM64_ROOTFS_SHA = "007b2c039e2242e8ee7abe8d98d7e330259305ce19f391163929f25f0a382c8b"
_CLAUDE_CODE_AMD64_ROOTFS_SHA = "bdd7a324683a2ce25dacfc53db1f039e595ff2f611da4677e2a14fa59952f30b"
_CLAUDE_CODE_ARM64_ROOTFS_SHA = "667aa073f11e9416292f14d69c1b68d933c3df4aa0b60c46e3a8999b384dc20b"
_HERMES_AMD64_ROOTFS_SHA = "227ca95fad257eecc929313d107b2e046c8f424899134deb9dd9332787b5b611"
...
# Complete Linux desktop image used by ``Celesto.computer()``.
...
_CODEX_AMD64_ALPINE_ROOTFS_SHA = "6fbf9adbd4d08872269a9988e8fee49da100b5308f2f40f97be2af1204714989"
_CODEX_ARM64_ALPINE_ROOTFS_SHA = "200bfbf445ef5cddac858ad623c7649aaac2c714aff3e3e699e453b00074d710"
_CLAUDE_CODE_AMD64_ALPINE_ROOTFS_SHA = (
    "ada7631340493a62fb9971894c0ddd967634853e6824a1e7f3734ff1a61b72ec"
)
_CLAUDE_CODE_ARM64_ALPINE_ROOTFS_SHA = (
    "66d43307b78f5be04e6b5ab44599eecf0ddb5df83be5169ffba01a39e97229cc"
)
_PI_AMD64_ALPINE_ROOTFS_SHA = "ceffda243035829895034cc7db7ec254f27dbe683a30343d11778b64c7389023"
_PI_ARM64_ALPINE_ROOTFS_SHA = "8f3bfcc4f6ff1c28c138fe6cf1ca1ce2c92221f33d2ee6dee38c6bb60499c812"
...
def published_targets(
    ...
    *,
    ...
    ``celesto image pull --all``) get the download targets without
...
def _decompress_zstd(src: Path, dst: Path) -> None:
    ...
    reflink support.
    """
    from celesto.host.disk import decompress_zstd_sparse
