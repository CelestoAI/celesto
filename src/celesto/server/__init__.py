...
"""Local HTTP server exposing Celesto over a typed REST API.

``celesto server start`` runs this FastAPI app on localhost so that
...
:class:`celesto.Celesto` facade, not a remote service.
"""
