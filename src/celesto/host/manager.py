...
"""Host environment management for Celesto.
...
from celesto.utils import unsafe_tar_member_kind, which
...
class HostCapability(str, Enum):
    """Host capabilities that Celesto depends on."""
    ...
    def install_firecracker(self, version: str | None = None) -> Path:
        ...
        try:
            ...
            raise HostError(
                ...
                f"fix that folder, or run celesto setup --firecracker-dir {fallback}."
            ) from e
    ...
    def _download_and_extract(self, url: str, dest: Path, version: str, arch: str) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with tarfile.open(tarball_path, "r:gz") as tar:
                ...
                # celesto.utils.unsafe_tar_member_kind.
