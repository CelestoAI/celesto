...
The QEMU command builder in ``celesto.runtime.qemu_args`` reads these fields
...
class GuestPlatformSpec:
    ...
    This is *data*, not behaviour. ``celesto.runtime.qemu_args.build_qemu_argv``
...
# Red Hat's RHEL Windows-guest guide. The supported Celesto workflow is
