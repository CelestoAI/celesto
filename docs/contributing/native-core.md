...
`smolvm-core` is the native helper package installed with Celesto on supported platforms. Most users never import it directly; contributors use it for accelerated host-side capabilities.
