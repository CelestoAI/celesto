...
class TestDetectArch:
    ...
    @patch("celesto.host.manager.platform.machine", return_value="aarch64")
...
class TestCheckKVM:
    ...
    @patch("celesto.host.manager.Path.exists", return_value=True)
    ...
    @patch("celesto.host.manager.Path.exists", return_value=False)
    ...
    @patch("celesto.host.manager.os.access", return_value=False)
    @patch("celesto.host.manager.Path.exists", return_value=True)
...
class TestCheckDependencies:
    ...
    @patch("celesto.host.manager.which")
...
class TestInstallFirecracker:
    ...
    @patch("celesto.host.manager.platform.machine", return_value="armv7l")
