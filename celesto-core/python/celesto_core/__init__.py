"""Rust-native helpers for Celesto.

Use this package directly when you are working on Celesto's native helpers or
checking which fast paths are available on a host. Most applications should use
the main :mod:`celesto` package instead.
"""
...
try:
    __version__ = version("celesto-core")
